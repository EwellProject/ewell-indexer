...
public class TokenTransferredLogEventProcessorTest : EwellIndexerPluginTestBase
{
    private readonly IAElfIndexerClientEntityRepository<UserBalanceIndex, LogEventInfo>
        _userBalanceIndexRepo;

    public TokenTransferredLogEventProcessorTest()
    {
        _userBalanceIndexRepo =
    ...
    public async Task HandleEventAsync_Test()
    {
        ...
        await MockTokenTransferred(chainId, symbol, transferAmount);
    ...
    private async Task MockTokenTransferred(string chainId, string symbol, long transferAmount)
    {
        ...
        var logEventProcessor = GetRequiredService<TokenTransferredLogEventProcessor>();
